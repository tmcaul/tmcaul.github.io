...
![Figure 1: An incident electron beam on a tilted sample generates a series of crossing bands (an electron backscatter pattern, EBSP).](https://cdn-images-1.medium.com/max/2000/1*SJlyfxnENtCl51Uvwzjo_g.png =200x300)

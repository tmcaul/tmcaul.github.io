...
1. Create an *AstroEBSD* .*pha* file (**Ni.pha**) and move it to **/phases/phasefiles**. You can copy a default one from the repository, for this tutorial the ONLY part that you need to edit are the following lines:
